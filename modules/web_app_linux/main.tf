...
# variables
variable "name" {
  description = "A name for Linux App Service "
  type        = string
}
variable "location" {
  description = "Azure location where Linux App Service will be deployed"
  type        = string
}
variable "tags" {
  type        = map(string)
...
variable "resource_group_name" {
  description = "The name of the resource group in which to create the Linux App Service."
  type        = string
}
...
output "default_hostname" {
  ...
  description = "Default Site Hostname for Linux Web App"
}