...
resource "azurerm_resource_group" "rg" {
  name     = "spacelift-test-web-app-linux"
  location = "EastUS"
}

// Linux web app with default values
module "linux_web_app" {
  source              = "../"
  name                = "spacelift-linux-web-app"
...
// Linux web app with custom values
module "linux_web_app_custom" {
  source              = "../"
  name                = "spacelift-linux-web-app-custom"
  location            = azurerm_resource_group.rg.location
  resource_group_name = azurerm_resource_group.rg.name
  service_plan_id     = "/subscriptions/d473e918-7273-4745-9214-3f7b999863a3/resourceGroups/spacelift-test-serviceplan/providers/Microsoft.Web/serverfarms/spacelift-serviceplan"
  tags = {
